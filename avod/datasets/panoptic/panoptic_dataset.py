...
from avod.datasets.panoptic import panoptic_aug
from avod.datasets.panoptic.panoptic_utils import PanopticUtils
...
class PanopticDataset:
    def __init__(self, dataset_config):
        ...
        Args:
            dataset_config: PanopticDatasetConfig
                name: unique name for the dataset
                data_split: "train", "val", "test", "trainval"
                data_split_dir: must be specified for custom "training"
                dataset_dir: Panoptic dataset dir if not in default location
        ...
        print('possible_splits = ', possible_splits)
        ...
        # Setup utils object
        self.panoptic_utils = PanopticUtils(self)
    ...
    def _set_up_directories(self):
        ...
        self.image_dir = self._data_split_dir + '/rgb_images'
    ...
    def get_rgb_image_path(self, sample_name):
        ...
        return self.rgb_image_dir + '/' + sample_name + '.jpg'
    ...
    def get_cluster_info(self):
        return self.panoptic_utils.clusters, self.panoptic_utils.std_devs

    def get_anchors_info(self, sample_name):
        return self.panoptic_utils.get_anchors_info(
            self.classes_name,
            self.panoptic_utils.anchor_strides,
            sample_name)
    ...
    def load_samples(self, indices):
        ...
        for sample_idx in indices:
            ...
            if self.has_labels:
                ...
                obj_labels = obj_panoptic_utils.read_labels(self.label_dir,
                                                   int(sample_name))
            ...
            point_cloud = self.panoptic_utils.get_point_cloud(self.bev_source,
                                                           img_idx,
                                                           image_shape)
            ...
            if panoptic_aug.AUG_FLIPPING in sample.augs:
                ...
                obj_labels = [panoptic_aug.flip_label_in_3d_only(obj)
