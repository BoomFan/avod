...
class PanopticUtilsTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_create_slice_filter(self):
        ...
        slice_filter = self.dataset.panoptic_utils.create_slice_filter(
    ...
    def test_filter_labels_by_class(self):
        ...
        filtered_labels = \
            self.dataset.panoptic_utils.filter_labels(obj_labels, difficulty=None)
        all_types = []
