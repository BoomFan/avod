...
from avod.protos import panoptic_dataset_pb2
from avod.protos.panoptic_dataset_pb2 import PanopticDatasetConfig
...
class DatasetBuilder(object):
    ...
    PANOPTIC_UNITTEST = PanopticDatasetConfig(
        ...
        dataset_dir=avod.root_dir() + "/tests/datasets/Panoptic/object",
        data_split="train",
